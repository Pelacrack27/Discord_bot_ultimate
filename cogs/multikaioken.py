...
class Multikaioken(commands.Cog):
  ...
  async def multikaioken(self, ctx):
    ...
    if random.randint(1, 10000) >= 9500:
        random1 = random.choice(featured_ssr_kaioken)
        await ctx.send(random1)
        if random1 == "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/0/0f/Card_1023600_thumb.png/revision/latest/scale-to-width-down/120?cb=20220725070715":
              puntos = puntos + 5
        elif random1 == "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/0/07/Card_1023500_thumb.png/revision/latest/scale-to-width-down/120?cb=20220725070618":
              puntos = puntos + 5
        else:
              puntos = puntos + 3
    else:
