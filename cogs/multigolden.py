...
featured_ssr_golden = [
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/c/c3/Card_1024490_thumb.png/revision/latest/scale-to-width-down/120?cb=20230113090722",
    ...
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/3/34/Card_1022460_thumb.png/revision/latest/scale-to-width-down/120?cb=20210828072614",
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/d/d2/Card_1017210_thumb.png/revision/latest/scale-to-width-down/120?cb=20191002074224",
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/a/a0/Card_1014380_thumb.png/revision/latest/scale-to-width-down/120?cb=20180831033522",
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/0/0c/Card_1004090_thumb.png/revision/latest/scale-to-width-down/120?cb=20151119181028",
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/3/3c/Card_1002100_thumb.png/revision/latest/scale-to-width-down/120?cb=20151022224636",
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/c/c1/Card_1010690_thumb.png/revision/latest/scale-to-width-down/120?cb=20170712093224",
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/e/e2/Card_1014320_thumb.png/revision/latest/scale-to-width-down/120?cb=20181121011503"
]

cualquier_ssr_golden = [
    ...
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/a/a2/Card_1024640_thumb.png/revision/latest/scale-to-width-down/120?cb=20221212074213",
...
cualquier_sr_golden = [
    "https://static.wikia.nocookie.net/dbz-dokkanbattle/images/0/05/Card_1001600_thumb.png/revision/latest/scale-to-width-down/120?cb=20180902213253",
...
class Multigolden(commands.Cog):
  ...
  async def on_ready(self):
    print("multigolden online")

  #Comandos del bot
  @commands.command()
  async def multigolden(self, ctx):
    ...
    for i in range(0, 9):
            ...
            if numero >= 9500:
                random2 = random.choice(featured_ssr_golden)
                await ctx.send(random2)
                puntos = puntos + 3
            elif numero >= 9000:
                await ctx.send(random.choice(cualquier_ssr_golden))
                puntos = puntos + 2
            elif numero >= 3000:
                await ctx.send(random.choice(cualquier_sr_golden))
                puntos = puntos + 1
            else:
                await ctx.send("<:R_eclair:971673105024045056> Personaje kk")  
    if random.randint(1, 10000) >= 9500:
        await ctx.send(random.choice(featured_ssr_golden))
        puntos = puntos + 3
    else:
        await ctx.send(random.choice(cualquier_ssr_golden))
        puntos = puntos + 2
...
def setup(client):
	client.add_cog(Multigolden(client))