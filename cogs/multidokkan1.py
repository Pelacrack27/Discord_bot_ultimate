...
class Multidokkan1(commands.Cog):
  ...
  async def on_ready(self):
    print("multidokkan1 online")

  #Comandos del bot
  @commands.command()
  async def multidokkan1(self, ctx):
    ...
    if random.randint(1, 10000) >= 9500:
        random1 = random.choice(featured_ssr_dokkan1)
...
def setup(client):
	client.add_cog(Multidokkan1(client))