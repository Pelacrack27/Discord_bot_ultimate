...
class Ayuda(commands.Cog):
  ...
  async def ayuda(self, ctx):
    ...
    embed.add_field(name="!tqgods (Tiquets)", value="Summon de tiquets de goku y vegeta ssj god septimo aniversario", inline=False)
    embed.add_field(name="!tqzdokkan (Tiquets)", value="Summon de tiquets de extreme z battle", inline=False)
    embed.add_field(name="!tqkaioken (Tiquets)", value="Summon de tiquets de goku (kaioken) y vegeta", inline=False)
